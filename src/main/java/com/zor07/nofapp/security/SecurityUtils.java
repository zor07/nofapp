...
public class SecurityUtils {
  ...
  public static boolean isUserAdmin(final com.zor07.nofapp.entity.user.User user) {
  ...
  public static String createAccessToken(final com.zor07.nofapp.entity.user.User user, final String issuer) {
